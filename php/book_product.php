...
<body  data-spy="scroll" data-target=".navbar" data-offset="50">
  ...
  <div class="row " style="padding-top:70px;">
    ...
    <div class="col-lg-6 croll" >
      <h2 style="text-align:center;">DANH SÁCH MÓN <span style="text-transform:uppercase;"><?php echo $ten_ban ;?><span></h2>
        <form action="<?=$url?>" method="post">
          <table class="table table-bordered">
            <thead class="thead-dark">
              <tr>
                <th style="width:100px;text-align:center;">tên món ăn</th>
                              ...
                              /*      if($action =="xoa-het"){
                                    ...
                                    //
                                      ...
                                      foreach($carts as $key => $cart) :
                                        ?>
                                        <tr>
                                          <td style="width:30%;text-align:center;" ><input type="text" name="ten_sp" value="<?php echo $cart['ten_sp']?>"></td>
                                  ...
                                  <div class="book__product-btn" style="padding-left:120px;">
